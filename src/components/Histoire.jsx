...
const Histoire = () => {
    return (
        <ColorText>
            ...
            <NoReverse>
                <Text1>The Dark explore Dominaria à l'époque qui suit la guerre des Frères (jusqu'à 400 ans après), dans une époque d'obscurantisme et d'obscurité. En effet, <ImportantText3>l'explosion du sylex par Urza</ImportantText3> a créé un nuage qui couvre le ciel, et va bientôt provoquer une ère glaciaire. <br></br><br></br>
                Nous suivons le mage Jodah, un descendant de la femme d'Urza laissée après la guerre. Après une attaque de gobelins, il fuit dans une Fontaine de jouvence, ce qui lui offrira une jeunesse éternelle. Au cours de ses voyages, il est amené à sauver <ImportantText2>Ith, grand arcaniste de Mairsil</ImportantText2>, le prétendant en utilisant un miroir transmis par son maître.</Text1>
                <Center>
